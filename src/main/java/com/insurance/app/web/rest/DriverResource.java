...
/**
 * REST controller for managing {@link com.insurance.app.domain.Driver}.
 */
@RestController
...
public class DriverResource {
    ...
    public ResponseEntity<Driver> partialUpdateDriver(
        ...
        Optional<Driver> result = driverRepository
            ...
            .map(existingDriver -> {
                ...
                if (driver.getYearsOfExperience() != null) {
                    existingDriver.setYearsOfExperience(driver.getYearsOfExperience());
                }
                if (driver.getAccidentHistory() != null) {
                    existingDriver.setAccidentHistory(driver.getAccidentHistory());
                }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Driver>> getAllDrivers(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
