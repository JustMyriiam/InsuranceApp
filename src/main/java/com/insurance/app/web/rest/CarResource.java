...
/**
 * REST controller for managing {@link com.insurance.app.domain.Car}.
 */
@RestController
    ...
    public ResponseEntity<Car> partialUpdateCar(@PathVariable(value = "id", required = false) final Long id, @RequestBody Car car)
        ...
        Optional<Car> result = carRepository
            ...
            .map(existingCar -> {
                ...
                if (car.getInsuranceStatus() != null) {
                    existingCar.setInsuranceStatus(car.getInsuranceStatus());
                }
                if (car.getCarType() != null) {
                    existingCar.setCarType(car.getCarType());
                }
                if (car.getIsBlacklisted() != null) {
                    existingCar.setIsBlacklisted(car.getIsBlacklisted());
                }
                if (car.getPriceWhenBought() != null) {
                    existingCar.setPriceWhenBought(car.getPriceWhenBought());
                }
                if (car.getCurrentPrice() != null) {
                    existingCar.setCurrentPrice(car.getCurrentPrice());
                }
