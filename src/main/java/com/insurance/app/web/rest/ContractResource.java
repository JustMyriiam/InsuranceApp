...
/**
 * REST controller for managing {@link com.insurance.app.domain.Contract}.
 */
@RestController
        ...
        Optional<Contract> result = contractRepository
            ...
            .map(existingContract -> {
                if (contract.getContractId() != null) {
                    existingContract.setContractId(contract.getContractId());
                }
                ...
                if (contract.getPremiumAmount() != null) {
                    existingContract.setPremiumAmount(contract.getPremiumAmount());
                }
                if (contract.getCoverageDetails() != null) {
                    existingContract.setCoverageDetails(contract.getCoverageDetails());
                }
                if (contract.getStatus() != null) {
                    existingContract.setStatus(contract.getStatus());
                }
                if (contract.getRenouvelable() != null) {
                    existingContract.setRenouvelable(contract.getRenouvelable());
                }
